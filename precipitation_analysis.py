...
for location in stations_data:
    ...
    for month in location_monthly_precipitation:
        yearly_precipitation += location_monthly_precipitation[month]
    ...
    for month in location_monthly_precipitation:
        relative_month_value = location_monthly_precipitation[month] / yearly_precipitation
        relative_monthly_precipitation[month] = relative_month_value
    ...
    relative_yearly_precipitation = yearly_precipitation / total_precipitation_all_cities
    print(f'RELATIVE {relative_yearly_precipitation}')
